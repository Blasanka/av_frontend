...
export class DirectInquiryComponent implements OnInit {
  ...
  quantity: any ;
  q:any;
  constructor(private productService: ProductService, private route: ActivatedRoute,private msgi: MessangerInquiryService,private service: NotificationsService) { }
